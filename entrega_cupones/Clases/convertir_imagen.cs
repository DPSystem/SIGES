...
namespace entrega_cupones.Clases
{
  public class convertir_imagen
  {
    ...
    public Image ByteArrayToImage(byte[] byteArrayIn) // reduce tamaño de la imagen
    {
      using (MemoryStream ms = new MemoryStream(byteArrayIn))
      {
        Image returnImage = Image.FromStream(ms);
        returnImage = returnImage.GetThumbnailImage(200, 200, () => false, IntPtr.Zero); // 134 px = 3.545 cm
        return returnImage;
      }
    }
