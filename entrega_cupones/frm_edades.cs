...
namespace entrega_cupones
{
  ...
  public partial class frm_edades : Form
  {
    ...
    private void btn_imprimir_Click(object sender, EventArgs e)
    {
      ...
      dgv_edades.Rows[3].Cells["edad"].Value = "9 a 12";
      dgv_edades.Rows[3].Cells["F"].Value = edades.Where(x => x.edad >= 9 && x.edad <= 12 && x.sexo == "F").Count();
      dgv_edades.Rows[3].Cells["M"].Value = edades.Where(x => x.edad >= 9 && x.edad <= 12 && x.sexo == "M").Count();
      dgv_edades.Rows[3].Cells["cantidad"].Value = edades.Where(x => x.edad >= 9 && x.edad <= 12 && x.sexo != " ").Count();

      dgv_edades.Rows[2].Cells["edad"].Value = "6 a 8";
      dgv_edades.Rows[2].Cells["F"].Value = edades.Where(x => x.edad >= 6 && x.edad <= 8  && x.sexo == "F").Count();
      dgv_edades.Rows[2].Cells["M"].Value = edades.Where(x => x.edad >= 6 && x.edad <= 8 && x.sexo == "M").Count();
      dgv_edades.Rows[2].Cells["cantidad"].Value = edades.Where(x => x.edad >= 6 && x.edad <= 8 && x.sexo != " ").Count();

      dgv_edades.Rows[1].Cells["edad"].Value = "3 a 5";
      dgv_edades.Rows[1].Cells["F"].Value = edades.Where(x => x.edad >= 3 && x.edad <= 5 && x.sexo == "F").Count();
      dgv_edades.Rows[1].Cells["M"].Value = edades.Where(x => x.edad >= 3 && x.edad <= 5 && x.sexo == "M").Count();
      dgv_edades.Rows[1].Cells["cantidad"].Value = edades.Where(x => x.edad >= 3 && x.edad <= 5 && x.sexo != " ").Count();

      dgv_edades.Rows[0].Cells["edad"].Value = "0 a 2";
      dgv_edades.Rows[0].Cells["F"].Value = edades.Where(x => x.edad >= 0 && x.edad <= 2 && x.sexo == "F").Count();
      dgv_edades.Rows[0].Cells["M"].Value = edades.Where(x => x.edad >= 0 && x.edad <= 2 && x.sexo == "M").Count();
      dgv_edades.Rows[0].Cells["cantidad"].Value = edades.Where(x => x.edad >= 0 && x.edad <= 2 && x.sexo != " ").Count();

      dgv_edades.Rows[4].Cells["edad"].Value = "sin sexo";
      dgv_edades.Rows[4].Cells["cantidad"].Value = edades.Where(x => x.edad >= 0 && x.edad <= 12 && x.sexo == " ").Count();

      lbl_total_edades.Text = edades.Where(x => x.edad >= 0 && x.edad <= 12).Count().ToString();
      //dgv_linq();
    }
