...
namespace entrega_cupones
{
  public partial class Login : Form
  {
    ...
    {
      if (MtdUsuarios.GetUserByName(txt_usuario.Text))
      {
        frm_CambiarContraseña f_CambiarContraseña = new frm_CambiarContraseña();
        f_CambiarContraseña._Usuario = txt_usuario.Text;
        f_CambiarContraseña.Lbl_Titulo.Text = "CAMBIAR CONTRASEÑA DE " + txt_usuario.Text; ;
        f_CambiarContraseña.ShowDialog();
      }
      else
      {
        MessageBox.Show("El usuario ingresado no existe. Porfavor ingrese usuario valido.", "Usuario no Existe");
        txt_usuario.Focus();
      }
    }
  }
