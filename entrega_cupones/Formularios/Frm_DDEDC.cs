...
{
  public partial class Frm_DDEDC : Form
  {
    ...
    private void EmitirCupon()
    {
      ...
      if (_Reimprimir == 0)
      {
        ...
        if (_NroCupon == 0)
        {
          ...
          //_EventoAñoId == 0 ? ImprimirCupon() : ImprimirCuponPredio();
      ...
      using (var context = new lts_sindicatoDataContext())
      {
        try
        {
          ...
          {   //Instanciamos un LocalReport, le indicamos el report a imprimir y le cargamos los datos
            ...
            {
              rdlc.ReportEmbeddedResource = "entrega_cupones.Reportes.Rpt_DDEDC_Entrada_Predio.rdlc";
            }
            else
            {
              rdlc.ReportEmbeddedResource = "entrega_cupones.Reportes.Rpt_DDEDC_Entrada_Predio_Acomp.rdlc";
            }
